...
public enum Lang {
    ...
    COMMAND_CLAIM_SUCCESSFUL("&aYou successfully claimed the chunk &e(&b{0}&a&e)&a! You now have &e(&2{1}&7/&2{2}&e) &aclaims."),
    COMMAND_ABANDONALLCLAIMS_SUCCESSFUL("&aYou successfully unclaimed all your chunks. You now have &e(&2{0}&7/&2{1}&e) &aclaims."),
    COMMAND_UNCLAIM_SUCCESSFUL("&aYou successfully unclaimed the chunk &e(&b{0}&a&e)&a!"),
    ...
    COMMAND_INFO_LINE_1("&6&lChunk Owner&7: &2{0}"),
    COMMAND_INFO_LINE_2("&6&lChunk Coordinate&7: &b{0}"),
    ...
    MENU_PLAYER_CHUNKS_TITLE("&2&lClaimed Chunks &8Page "),
