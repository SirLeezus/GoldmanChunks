...
public enum Lang {
    ...
    ERROR_COMMAND_SELL_NOT_CLAIMED("&cThe chunk you're currently standing on is not claimed."),
    ERROR_COMMAND_SELL_ADMIN_CHUNK("&cYou can not sell admin chunks."),
    ERROR_COMMAND_SELL_NOT_OWNER("&cThe chunk you're currently standing on is owned by &6{0} &cand only they are able to put a chunk up for sale."),
    ERROR_COMMAND_SELL_MAX_VALUE("&cYou can only sell a chunk for a max of ${0}&c."),
    ERROR_COMMAND_SELL_NOT_NUMBER("&cThe input &b{0} &cis not a accepted value. You need to input a sell price, decimals are not supported."),
    ERROR_COMMAND_SELL_NO_NUMBER("&cYou need to input a number for how much you would like to sell the chunk you're standing on. Keep in mind decimals are not supported."),
    ...
    COMMAND_SELL_SUCCESSFUL("&aYou successfully put your chunk &e(&b{0}&e) &aup for sale for the price of &6${1}&a!"),
