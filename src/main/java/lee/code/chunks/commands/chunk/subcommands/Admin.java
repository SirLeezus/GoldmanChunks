                        ...
                        default:
                            ...
                            switch (args[2]) {
                                ...
                                case "add":
                                    ...
                                    player.sendMessage(Lang.PREFIX.getString(null) + Lang.COMMAND_ADMIN_BONUS_CLAIMS_ADD.getString(new String[] { plugin.getUtility().formatAmount(amount), target.getName() }));
                                    break;
                                case "remove":
                                    SQL.removeBonusClaims(targetUUID, amount);
                                    player.sendMessage(Lang.PREFIX.getString(null) + Lang.COMMAND_ADMIN_BONUS_CLAIMS_REMOVE.getString(new String[] { plugin.getUtility().formatAmount(amount), target.getName() }));
                                    break;
                                case "set":
                                    SQL.setBonusClaims(targetUUID, amount);
                                    player.sendMessage(Lang.PREFIX.getString(null) + Lang.COMMAND_ADMIN_BONUS_CLAIMS_SET.getString(new String[] { plugin.getUtility().formatAmount(amount), target.getName() }));
                                    break;
