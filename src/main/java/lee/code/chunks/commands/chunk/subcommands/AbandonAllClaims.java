...
public class AbandonAllClaims extends SubCommand {
    ...
    public void perform(Player player, String[] args) {
        ...
        if (SQL.hasClaimedChunks(uuid)) {
            ...
            player.sendMessage(Lang.PREFIX.getString(null) + Lang.COMMAND_ABANDONALLCLAIMS_SUCCESSFUL.getString(new String[] { plugin.getUtility().formatAmount(totalClaims), plugin.getUtility().formatAmount(maxClaims) }));
