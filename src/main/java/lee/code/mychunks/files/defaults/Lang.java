...
public enum Lang {
    ...
    ERROR_ADMIN_CLAIMED("ERROR_ADMIN_CLAIMED", "&cSadly this chunk has already been claimed as a Admin chunk."),
    ...
    COMMAND_ADMIN_CLAIM_FIRST_CHUNK_SELECTED("COMMAND_ADMIN_CLAIM_FIRST_CHUNK_SELECTED", "&aYou successfully selected the chunk &e(&b{0}&e)&a! Now run the command &6/adminchunk claim &aagain to claim all chunks between this selected chunk."),
